# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-08-22 22:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('platename', models.CharField(max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('portrait', models.ImageField(null=True, upload_to='file')),
                ('username', models.CharField(max_length=200, null=True)),
                ('gender', models.IntegerField(choices=[('0', '女'), ('1', '男')], default=0, null=True)),
            ],
            options={
                'db_table': 'mi_user',
                'managed': True,
